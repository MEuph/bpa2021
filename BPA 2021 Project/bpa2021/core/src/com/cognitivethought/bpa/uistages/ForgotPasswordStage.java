...
public class ForgotPasswordStage extends LauncherStage {
	...
	public ForgotPasswordStage(Viewport vp) {
		...
		fp_elements.setPosition(Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
	...
	public void populate() {
		...
		fp_newPass.setPasswordMode(true);
		fp_newPass.setPasswordCharacter('*');
		
		fp_verifyNewPass.setPasswordMode(true);
		fp_verifyNewPass.setPasswordCharacter('*');
		...
		final ForgotPasswordStage fp_stage = this;
