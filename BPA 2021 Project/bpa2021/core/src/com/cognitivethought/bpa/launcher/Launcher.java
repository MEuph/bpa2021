...
public class Launcher extends ApplicationAdapter {
	...
	public void setStage(Stage s) {
		if (currentStage != null) currentStage.unfocusAll();
		currentStage = s;
	...
	private void populateUI() {
		...
		newAccountStage.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				if (!isClickingOnUIElement(x, y, na_email, na_password, na_username, na_createUser)) {
		...
		na_username.setSize(200, textStyle.font.getLineHeight());
		na_email.setSize(200, textStyle.font.getLineHeight());
		na_password.setSize(200, textStyle.font.getLineHeight());
		...
		loginStage.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				if (!isClickingOnUIElement(x, y, login_password, login_username, login_submit)) {
		...
		login_username.setSize(200, textStyle.font.getLineHeight());
		login_password.setSize(200, textStyle.font.getLineHeight());
